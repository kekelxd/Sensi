...
const labels = {
  ...
  en: { home: 'HOME', train: 'TRAIN', calibrate: 'CALIBRATE', convert: 'CONVERT', diagnostic: 'DIAGNOSTICS', analysis: 'ANALYSIS', minigames: 'Minigames', minigamesDescription: 'Individual exercises', routinesDescription: 'Training sequences', routines: 'Routines', calibration: 'Calibrate sensitivity', history: 'History', method: 'Methodology', polling: 'Polling Rate Test', pollingDescription: 'Measure the mouse update frequency received by the browser.', input: 'Input Diagnostics', inputDescription: 'Analyze input stability and behavior.', profile: 'My profile', preferences: 'Preferences', settings: 'Settings', logout: 'Sign out', unavailable: 'Available when sign-in is enabled' },
