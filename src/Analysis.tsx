...
export function Analysis({ section }: Props) {
  ...
  return <section className="analysis-workspace">
    <header><h1>{showOnlyCalibration ? text.calibration : text.title}</h1><p>{text.subtitle}</p></header>
